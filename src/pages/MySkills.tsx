          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <TabsContent value="teaching" className="space-y-4">
              {loading ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  No teaching skills yet. <a href="/create-skill" className="text-primary hover:underline">Create your first skill!</a>
                </div>
              ) : (
            ...
            <TabsContent value="learning" className="space-y-4">
              {loading ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  No learning skills yet. <a href="/marketplace" className="text-primary hover:underline">Browse skills to learn!</a>
                </div>
              ) : (
